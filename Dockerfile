...
RUN curl -s https://raw.githubusercontent.com/yarnpkg/berry/master/packages/berry-cli/bin/berry.js > ${MAIN_YARN_DIR}/releases/yarn-berry.js && \
...
# RUN curl -s https://raw.githubusercontent.com/yarnpkg/berry/master/packages/plugin-workspace-tools/bin/%40yarnpkg/plugin-workspace-tools.js -o ${MAIN_YARN_DIR}/plugin-workspace-tools.js
